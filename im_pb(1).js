...
goog.exportSymbol('proto.im.AppType', null, global);
...
goog.exportSymbol('proto.im.MsgType', null, global);
...
proto.im.Login.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.im.AppType} */ (reader.readEnum());
      msg.setAppid(value);
      break;
    case 3:
...
/**
 * optional AppType appId = 2;
 * @return {!proto.im.AppType}
 */
proto.im.Login.prototype.getAppid = function() {
  return /** @type {!proto.im.AppType} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {!proto.im.AppType} value */
...
proto.im.MsgSend = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.im.MsgSend.repeatedFields_, null);
};
 ...
 * @const
 */
proto.im.MsgSend.repeatedFields_ = [12];
...
proto.im.MsgSend.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    messageid: jspb.Message.getFieldWithDefault(msg, 8, 0),
    sessionid: jspb.Message.getFieldWithDefault(msg, 9, 0),
    sessiontype: jspb.Message.getFieldWithDefault(msg, 11, 0),
    remindidList: jspb.Message.getRepeatedField(msg, 12),
...
proto.im.MsgSend.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = /** @type {!proto.im.MsgType} */ (reader.readEnum());
      msg.setType(value);
      break;
    case 5:
      var value = /** @type {!proto.im.AppType} */ (reader.readEnum());
 ...
 * @return {number}
 */
proto.im.MsgSend.prototype.getSid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.im.MsgSend.prototype.setSid = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!proto.im.MsgType}
 */
proto.im.MsgSend.prototype.getType = function() {
  return /** @type {!proto.im.MsgType} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};


/** @param {!proto.im.MsgType} value */
...
/**
 * optional AppType appId = 5;
 * @return {!proto.im.AppType}
 */
proto.im.MsgSend.prototype.getAppid = function() {
  return /** @type {!proto.im.AppType} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};


/** @param {!proto.im.AppType} value */
proto.im.MsgSend.prototype.setAppid = function(value) {
...
/**
 * repeated int32 remindId = 12;
 * @return {!Array.<number>}
 */
proto.im.MsgSend.prototype.getRemindidList = function() {
  return /** @type {!Array.<number>} */ (jspb.Message.getRepeatedField(this, 12));
};


/** @param {!Array.<number>} value */
proto.im.MsgSend.prototype.setRemindidList = function(value) {
 ...
 */
proto.im.MsgSend.prototype.addRemindid = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 12, value, opt_index);
};


proto.im.MsgSend.prototype.clearRemindidList = function() {
  this.setRemindidList([]);
};
...
proto.im.MsgNotice.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    sequenceid: jspb.Message.getFieldWithDefault(msg, 5, 0),
    time: jspb.Message.getFieldWithDefault(msg, 6, 0)
  };
...
/**
 * optional AppType appId = 3;
 * @return {!proto.im.AppType}
 */
proto.im.MsgNotice.prototype.getAppid = function() {
  return /** @type {!proto.im.AppType} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {number}
 */
proto.im.MsgRead.prototype.getSid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.im.MsgRead.prototype.setSid = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!proto.im.AppType}
 */
proto.im.MsgRead.prototype.getAppid = function() {
  return /** @type {!proto.im.AppType} */ (jspb.Message.getFieldWithDefault(this, 5, 0));
};


/** @param {!proto.im.AppType} value */
proto.im.MsgRead.prototype.setAppid = function(value) {
  jspb.Message.setProto3EnumField(this, 5, value);
};
 ...
 * @return {number}
 */
proto.im.Ping.prototype.getUid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.im.Ping.prototype.setUid = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!proto.im.AppType}
 */
proto.im.Ping.prototype.getAppid = function() {
  return /** @type {!proto.im.AppType} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {!proto.im.AppType} value */
proto.im.Ping.prototype.setAppid = function(value) {
  jspb.Message.setProto3EnumField(this, 2, value);
};
